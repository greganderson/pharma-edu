...
const Search: FunctionComponent<SearchType> = ({ className = "" }) => {
  ...
  return (
    <div
      className={`w-[186px] flex flex-row items-start justify-start pt-[24.9px] pb-[13.1px] pl-[23px] pr-[22px] box-border relative cursor-pointer text-left text-17xl text-white font-roboto ${className}`}
