...
const NewDrSearch: FunctionComponent<NewDrSearchType> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute h-[45.6%] w-[95.85%] top-[30.43%] left-[4.15%] leading-[41.12px] font-medium inline-block z-[1] mq450:text-3xl mq450:leading-[25px] mq1050:text-10xl mq1050:leading-[33px]">
