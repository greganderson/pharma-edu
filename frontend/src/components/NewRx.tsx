...
const NewRx: FunctionComponent<NewRxType> = ({
  ...
  return (
    <div
      className={`w-[206px] flex flex-row items-start justify-start pt-[79.1px] px-6 pb-[60px] box-border relative cursor-pointer z-[1] text-left text-17xl text-white font-roboto ${className}`}
      onClick={handleClick}
    >
