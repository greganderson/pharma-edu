...
const NewPtSearch: FunctionComponent<NewPtSearchType> = ({
  ...
  return (
    <div
      className={`w-[206px] flex flex-row items-start justify-start pt-11 px-[26px] pb-[49.1px] box-border relative cursor-pointer z-[1] text-left text-17xl text-white font-roboto ${className}`}
    ...
    >
      ...
      <a className="[text-decoration:none] flex-1 relative leading-[41.12px] font-medium text-[inherit] z-[1] mq450:text-3xl mq450:leading-[25px] mq1050:text-10xl mq1050:leading-[33px]">
