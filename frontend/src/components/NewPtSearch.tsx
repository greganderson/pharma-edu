...
const NewPtSearch: FunctionComponent<NewPtSearchType> = ({
  ...
  const onNewPtSearchClick = useCallback(() => {
    // Navigate to home or sync "New Patient" to the project
    navigate("/");
  ...
  return (
    ...
    >
      ...
      <div className="[text-decoration:none] flex-1 relative leading-[41.12px] font-medium text-[inherit] z-[1] mq450:text-3xl mq450:leading-[25px] mq1050:text-10xl mq1050:leading-[33px]">
