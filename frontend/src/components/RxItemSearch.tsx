...
const RxItemSearch: FunctionComponent<RxItemSearchType> = ({
  ...
  return (
    <div
      className={`flex-1 flex flex-row items-start justify-start pt-[50px] pb-[50px] pl-px pr-0 box-border relative min-w-[136px] cursor-pointer z-[1] ml-[-11px] text-left text-17xl text-white font-roboto mq450:ml-0 ${className}`}
